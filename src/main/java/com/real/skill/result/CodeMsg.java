...
public class CodeMsg {
    ...
    public static CodeMsg ACCESS_LIMIT = new CodeMsg(500103,"请求过于频繁！");
    ...
    public static CodeMsg PASSWORD_ALTER_ERROR = new CodeMsg(500216,"密码修改失败");
    //商品模块 5003XX
